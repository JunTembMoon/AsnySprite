...
If you don't like the default look of AsnySprite, DON'T PANIC, there's plenty of community made themes that make the app looks awesome.
...
Then open AsnySprite up, go to Edit, Preferences and go to the Theme tab.
...
Restart AsnySprite to see the changes.
...
**NOTE: DO NOT DELETE THE FILES BEFORE YOU CHANGE THE THEME** If this does happen, simply copy the original, call it the same as the deleted theme and launch AsnySprite again.

If this doesn't fix it, then, you'll need to reinstall the theme and try again the steps above, or reinstall AsnySprite.
