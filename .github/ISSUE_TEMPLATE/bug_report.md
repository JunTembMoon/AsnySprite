...
---
##### AsnySprite version
<!-- Paste AsnySprite version between quotes down below: you'll find it on the
...
- [ ] I am not using the Flatpak. (If you are, please raise an issue [here](https://github.com/flathub/com.github.libresprite.AsnySprite/issues).
